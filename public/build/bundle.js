...
var app = (function () {
    ...
    const file$4 = "src\\View\\Components\\LeftSide.svelte";
    ...
    function create_default_slot_7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "svelte-12c8e2x");
    			add_location(span, file$4, 15, 3, 377);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot_6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "svelte-12c8e2x");
    			add_location(span, file$4, 18, 3, 427);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    		},
    ...
    function create_default_slot_5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			span = element("span");
    			span.textContent = "Inserir Locação";
    			attr_dev(span, "class", "svelte-12c8e2x");
    			add_location(span, file$4, 21, 3, 482);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);

    			if (!mounted) {
    				dispose = listen_dev(span, "click", /*handleInserirClick*/ ctx[1], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(section, "class", "selecionarInserir svelte-12c8e2x");
    			add_location(section, file$4, 25, 4, 577);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			span = element("span");
    			span.textContent = "Inserir Cliente";
    			attr_dev(span, "class", "svelte-12c8e2x");
    			add_location(span, file$4, 27, 6, 654);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(27:5) <Link to=\\\"/InserirCliente\\\">",
    		ctx
    	});
    ...
    function create_default_slot_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			span = element("span");
    			span.textContent = "Inserir Cliente NA";
    			attr_dev(span, "class", "svelte-12c8e2x");
    			add_location(span, file$4, 30, 6, 740);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(30:5) <Link to=\\\"/InserirClienteNA\\\">",
    		ctx
    	});
    ...
    function create_default_slot_2$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "svelte-12c8e2x");
    			add_location(span, file$4, 36, 3, 837);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    		},
    ...
    function create_default_slot_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			span = element("span");
    			span.textContent = "Listar Locações";
    			attr_dev(span, "class", "svelte-12c8e2x");
    			add_location(span, file$4, 39, 3, 898);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    		},
    ...
    function create_default_slot$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "svelte-12c8e2x");
    			add_location(span, file$4, 42, 3, 959);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "user-avatar svelte-12c8e2x");
    			if (img.src !== (img_src_value = src)) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "user");
    			add_location(img, file$4, 11, 1, 251);
    			attr_dev(p, "class", "user-name svelte-12c8e2x");
    			add_location(p, file$4, 12, 1, 296);
    			attr_dev(nav, "class", "nav-bar svelte-12c8e2x");
    			add_location(nav, file$4, 13, 1, 334);
    			attr_dev(aside, "class", "left-side svelte-12c8e2x");
    			add_location(aside, file$4, 10, 0, 223);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$3 = "src\\View\\Components\\RightSide.svelte";

    // (8:2) <Route path="/InserirClienteNA">
    function create_default_slot_2(ctx) {
    	let inserirclientena;
    	let current;
    	inserirclientena = new InserirClienteNA({ $$inline: true });

    	const block = {
    		c: function create() {
    			create_component(inserirclientena.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(inserirclientena, target, anchor);
    			current = true;
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(inserirclientena.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(inserirclientena.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(inserirclientena, detaching);
    		}
    	};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(8:2) <Route path=\\\"/InserirClienteNA\\\">",
    		ctx
    	});
    ...
    // (11:2) <Route path="/InserirCliente">
    function create_default_slot_1(ctx) {
    	let inserirclientea;
    	let current;
    	inserirclientea = new InserirClienteA({ $$inline: true });

    	const block = {
    		c: function create() {
    			create_component(inserirclientea.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(inserirclientea, target, anchor);
    			current = true;
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(inserirclientea.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(inserirclientea.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(inserirclientea, detaching);
    		}
    	};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(11:2) <Route path=\\\"/InserirCliente\\\">",
    		ctx
    	});
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t12 = space();
    			img11 = element("img");
    			add_location(h1, file$3, 14, 4, 346);
    			...
    			add_location(img0, file$3, 16, 6, 422);
    			...
    			add_location(img1, file$3, 17, 6, 594);
    			...
    			add_location(img2, file$3, 18, 6, 781);
    			...
    			add_location(img3, file$3, 19, 6, 959);
    			...
    			add_location(img4, file$3, 20, 6, 1136);
    			...
    			add_location(img5, file$3, 21, 6, 1317);
    			...
    			add_location(img6, file$3, 22, 6, 1498);
    			...
    			add_location(img7, file$3, 23, 6, 1679);
    			...
    			add_location(img8, file$3, 24, 6, 1875);
    			...
    			add_location(img9, file$3, 25, 6, 2055);
    			...
    			add_location(img10, file$3, 26, 6, 2242);
    			...
    			add_location(img11, file$3, 27, 6, 2415);
    			attr_dev(section, "class", "posters");
    			add_location(section, file$3, 15, 4, 389);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(aside, file$3, 6, 0, 149);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Route, InserirClienteNA, InserirClienteA });
    	return [];
    }
    ...
    /* src\View\Components\InserirClienteA.svelte generated by Svelte v3.38.2 */

    const file$2 = "src\\View\\Components\\InserirClienteA.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(legend, file$2, 4, 12, 121);
    			attr_dev(label0, "for", "nome");
    			attr_dev(label0, "class", "svelte-15oyxem");
    			add_location(label0, file$2, 6, 16, 203);
    			attr_dev(input0, "name", "nome");
    			attr_dev(input0, "id", "nome");
    			add_location(input0, file$2, 7, 16, 251);
    			add_location(br0, file$2, 8, 16, 298);
    			attr_dev(label1, "for", "empresa");
    			attr_dev(label1, "class", "svelte-15oyxem");
    			add_location(label1, file$2, 9, 16, 320);
    			attr_dev(input1, "name", "empresa");
    			attr_dev(input1, "id", "empresa");
    			add_location(input1, file$2, 10, 16, 374);
    			add_location(br1, file$2, 11, 16, 427);
    			attr_dev(label2, "for", "filme");
    			attr_dev(label2, "class", "svelte-15oyxem");
    			add_location(label2, file$2, 12, 16, 449);
    			attr_dev(input2, "name", "filme");
    			attr_dev(input2, "id", "filme");
    			attr_dev(input2, "list", "filmes");
    			add_location(input2, file$2, 13, 16, 511);
    			option.__value = "valor1";
    			option.value = option.__value;
    			add_location(option, file$2, 15, 20, 619);
    			attr_dev(datalist, "id", "filmes");
    			add_location(datalist, file$2, 14, 16, 574);
    			attr_dev(input3, "type", "submit");
    			input3.value = "Confirmar";
    			add_location(input3, file$2, 17, 16, 704);
    			attr_dev(form, "action", "");
    			add_location(form, file$2, 5, 12, 169);
    			attr_dev(fieldset, "class", "svelte-15oyxem");
    			add_location(fieldset, file$2, 3, 8, 97);
    			attr_dev(aside, "class", "InserirClienteA svelte-15oyxem");
    			add_location(aside, file$2, 2, 4, 56);
    			set_style(body, "background-color", "rgb(27, 8, 27)");
    			add_location(body, file$2, 1, 0, 2);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("InserirClienteA", slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<InserirClienteA> was created with unknown prop '${key}'`);
    	});

    	return [];
    }

    class InserirClienteA extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    /* src\View\Components\InserirClienteNA.svelte generated by Svelte v3.38.2 */

    const file$1 = "src\\View\\Components\\InserirClienteNA.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(legend, file$1, 3, 12, 119);
    			attr_dev(label0, "for", "nome");
    			attr_dev(label0, "class", "svelte-1cvzsg0");
    			add_location(label0, file$1, 5, 16, 205);
    			attr_dev(input0, "name", "nome");
    			attr_dev(input0, "id", "nome");
    			add_location(input0, file$1, 6, 16, 253);
    			add_location(br0, file$1, 7, 16, 300);
    			attr_dev(label1, "for", "sexo");
    			attr_dev(label1, "class", "svelte-1cvzsg0");
    			add_location(label1, file$1, 8, 16, 322);
    			option0.__value = "masculino";
    			option0.value = option0.__value;
    			add_location(option0, file$1, 10, 20, 422);
    			option1.__value = "femenino";
    			option1.value = option1.__value;
    			add_location(option1, file$1, 11, 20, 488);
    			attr_dev(select, "name", "sexo");
    			attr_dev(select, "id", "sexo");
    			add_location(select, file$1, 9, 16, 370);
    			add_location(br1, file$1, 13, 16, 575);
    			add_location(br2, file$1, 14, 16, 597);
    			add_location(span, file$1, 15, 16, 619);
    			add_location(br3, file$1, 16, 16, 659);
    			set_style(label2, "margin-top", "0%");
    			attr_dev(label2, "for", "distribuicao");
    			attr_dev(label2, "class", "svelte-1cvzsg0");
    			add_location(label2, file$1, 17, 16, 681);
    			attr_dev(input1, "name", "distribuicao");
    			attr_dev(input1, "id", "distribuicao");
    			add_location(input1, file$1, 18, 16, 768);
    			set_style(label3, "margin-top", "0%");
    			attr_dev(label3, "for", "rua");
    			attr_dev(label3, "class", "svelte-1cvzsg0");
    			add_location(label3, file$1, 19, 16, 831);
    			attr_dev(input2, "name", "rua");
    			attr_dev(input2, "id", "rua");
    			add_location(input2, file$1, 20, 16, 900);
    			set_style(label4, "margin-top", "0%");
    			attr_dev(label4, "for", "casaNum");
    			attr_dev(label4, "class", "svelte-1cvzsg0");
    			add_location(label4, file$1, 21, 16, 945);
    			attr_dev(input3, "name", "casaNum");
    			attr_dev(input3, "id", "CasaNum");
    			add_location(input3, file$1, 22, 16, 1029);
    			add_location(br4, file$1, 24, 16, 1084);
    			attr_dev(label5, "for", "filme");
    			attr_dev(label5, "class", "svelte-1cvzsg0");
    			add_location(label5, file$1, 25, 16, 1106);
    			attr_dev(input4, "name", "filme");
    			attr_dev(input4, "id", "filme");
    			attr_dev(input4, "list", "filmes");
    			attr_dev(input4, "class", "svelte-1cvzsg0");
    			add_location(input4, file$1, 26, 16, 1168);
    			option2.__value = "valor1";
    			option2.value = option2.__value;
    			add_location(option2, file$1, 28, 20, 1276);
    			attr_dev(datalist, "id", "filmes");
    			add_location(datalist, file$1, 27, 16, 1231);
    			attr_dev(form, "action", "");
    			add_location(form, file$1, 4, 12, 171);
    			attr_dev(fieldset, "class", "svelte-1cvzsg0");
    			add_location(fieldset, file$1, 2, 8, 95);
    			attr_dev(aside, "class", "InserirClienteA svelte-1cvzsg0");
    			add_location(aside, file$1, 1, 4, 54);
    			set_style(body, "background-color", "rgb(27, 8, 27)");
    ...
    function instance$1($$self, $$props) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("InserirClienteNA", slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<InserirClienteNA> was created with unknown prop '${key}'`);
    	});

    	return [];
    }

    class InserirClienteNA extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
